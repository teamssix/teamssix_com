---
title: 获取无法直接执行命令的 Windows 实例权限
date: 2023-05-13 13:17:20
id: 230513-131720
img: https://cdn.jsdelivr.net/gh/teamssix/BlogImages/imgs/202305131353828.png
tags:
- 云安全
- ECS
- 经验总结
...
![](https://cdn.jsdelivr.net/gh/teamssix/BlogImages/imgs/202305131352449.png)

根据刚才的思路，为这台实例的系统盘创建一个快照

![](https://cdn.jsdelivr.net/gh/teamssix/BlogImages/imgs/202305131352142.png)

通过这个快照创建磁盘

![](https://cdn.jsdelivr.net/gh/teamssix/BlogImages/imgs/202305131353976.png)

接着创建一个实例，在创建实例的时候，要注意可用区的选择，需要选择和磁盘在一个可用区，否则会无法挂载。

![](https://cdn.jsdelivr.net/gh/teamssix/BlogImages/imgs/202305131353728.png)

将刚创建的磁盘挂载到刚创建的实例中

![](https://cdn.jsdelivr.net/gh/teamssix/BlogImages/imgs/202305131353592.png)

远程连接刚创建的实例，可以看到磁盘已经挂载上了，如果没有看到则可以在磁盘管理里找找

![](https://cdn.jsdelivr.net/gh/teamssix/BlogImages/imgs/202305131353128.png)
...
![](https://cdn.jsdelivr.net/gh/teamssix/BlogImages/imgs/202305131353828.png)

可以看到获取到了 3 个用户的 Hash、2 个明文密码，经过尝试，第 2 个明文密码就是 cloudbase-init 用户的密码，因此这里就可以利用这个密码直接远程登录目标实例了。

![](https://cdn.jsdelivr.net/gh/teamssix/BlogImages/imgs/202305131354811.png)
